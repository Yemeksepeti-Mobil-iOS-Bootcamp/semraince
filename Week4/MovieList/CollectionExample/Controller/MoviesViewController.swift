...
class MoviesViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate ,UICollectionViewDelegateFlowLayout{
    ...
    @objc func changeLayout(){
        ...
        if list{
            ...
            self.navigationItem.rightBarButtonItem?.image =  UIImage(named: "gridd");
        }
        else{
            
            self.navigationItem.rightBarButtonItem?.image =  UIImage(named: "listt");
        }
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(named: "listt"),
                                                                 style: .plain,
                                                                 target: self,
